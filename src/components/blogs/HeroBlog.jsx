...
const HeroBlog = ({ blog }) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "leading-6 lg:leading-7 text-md max-md:text-sm px-2 py-2 text-black outline-none border-y-2 border-gray-500",
      },
    },
    content: editorState,
  });
    ...
    <div className="w-4/6 max-md:w-full max-lg:mx-auto bg-white rounded-md shadow-md border-black pb-4">
      ...
      <div className="max-sm:mx-4 mx-16">
        <div className="flex my-6 ">
          <Image
            src={blog.authorImg || "/manicon.webp"}
            alt="User Image"
            width={50}
            height={50}
        ...
        <div className="my-6 font-serif">
          ...
          <div className="prose prose-sm md:prose-lg bg-white/80 duration-200 max-w-[870px] py-3">
