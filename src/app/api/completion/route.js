...
export const POST = async (req) => {
  ...
  const response = await openai.createChatCompletion({
    ...
    messages: [
      {
        role: "system",
        content: `You are a helpful AI embedded in a blog/content cretion app that is used to autocomplete sentences.
      ...
      },
      {
        ...
        keep the response short within 2 or three sentence and sweet.
